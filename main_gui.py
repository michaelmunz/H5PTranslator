...
class main_gui(tk.Tk):
    ...
    def __init__(self):
        ...
        self.btn_replace_images.grid(row=3,column=0, columnspan=2)

        ttk.Label(text="Untranslated IDs:").grid(row=4,column=0, columnspan=2)
        self.txt_untranslated_ids = tk.Text(height=10, width=40)
        self.txt_untranslated_ids.grid(row=5,column=0, columnspan=2)

        ttk.Label(text="Modified IDs:").grid(row=6,column=0, columnspan=2)
        self.txt_modified_ids = tk.Text(height=10, width=40)
        self.txt_modified_ids.grid(row=7,column=0, columnspan=2)
    ...
    def fileopen_base(self):
        ...
        for t in modified_ids:
            self.modified_ids.insert(tk.END, t+"\n")

        self.txt_modified_ids = modified_ids
    ...
    def do_translate(self):
        ...
        for id in untranslated_ids:
            ...
            autotranslated_text = self.h5ptrans.getAutoTranslation("en", "de", elem.getText())
